...
class DataElementIso:
    ...
    BITS_VALUE_TYPE[0] = ['','','','','']
    BITS_VALUE_TYPE[1] = ['BME','Bit Map Extended','B',16,'b']
    ...
    BITS_VALUE_TYPE[5] = ['5','Amount reconciliation','N',12,'n']
    BITS_VALUE_TYPE[6] = ['6','Amount cardholder billing','N',12,'n']
    BITS_VALUE_TYPE[7] = ['7','Date and time transmission','N',10,'n']
    BITS_VALUE_TYPE[8] = ['8','Amount cardholder billing fee','N',8,'n']
    BITS_VALUE_TYPE[9] = ['9','Conversion rate reconciliation','N',8,'n']
    BITS_VALUE_TYPE[10] = ['10','Conversion rate cardholder billing','N',8,'n']
    BITS_VALUE_TYPE[11] = ['11','Systems trace audit number','N',6,'n']
    BITS_VALUE_TYPE[12] = ['12','Date and time local transaction','N',6,'n']
    BITS_VALUE_TYPE[13] = ['13','Date effective','N',4,'n']
    ...
    BITS_VALUE_TYPE[22] = ['22','Point of service data code','N',3,'n']
    BITS_VALUE_TYPE[23] = ['23','Card sequence number','N',3,'n']
    BITS_VALUE_TYPE[24] = ['24','Function code','N',3,'n']
    BITS_VALUE_TYPE[25] = ['25','Message reason code','N',2,'n']
    BITS_VALUE_TYPE[26] = ['26','Merchant category code','N',2,'n']
    BITS_VALUE_TYPE[27] = ['27','Point of service capability','N',1,'n']
    BITS_VALUE_TYPE[28] = ['28','Date reconciliation','N',8,'n']
    BITS_VALUE_TYPE[29] = ['29','Reconciliation indicator','N',8,'n']
    BITS_VALUE_TYPE[30] = ['30','Amounts original','N',8,'n']
    BITS_VALUE_TYPE[31] = ['31','Acquirer reference number','N',8,'n']
    ...
    BITS_VALUE_TYPE[34] = ['34','Electronic commerce data','LL',28,'n']
    ...
    BITS_VALUE_TYPE[46] = ['46','Amounts fees','LLL',999,'an']
    BITS_VALUE_TYPE[47] = ['47','Additional data national','LLL',999,'an']
    BITS_VALUE_TYPE[48] = ['48','Additional data private','LLL',999,'an']
    BITS_VALUE_TYPE[49] = ['49','Verification data','A',3,'a']
    BITS_VALUE_TYPE[50] = ['50','Currency code, settlement','AN',3,'an']
    BITS_VALUE_TYPE[51] = ['51','Currency code, cardholder billing','A',3,'a']
    BITS_VALUE_TYPE[52] = ['52','Personal identification number (PIN) data','B',16,'b']
    BITS_VALUE_TYPE[53] = ['53','Security related control information','LL',18,'n']
    BITS_VALUE_TYPE[54] = ['54','Amounts additional','LLL',120,'an']
    BITS_VALUE_TYPE[55] = ['55','Integrated circuit card (ICC) system related data','LLL',999,'ans']
    BITS_VALUE_TYPE[56] = ['56','Original data elements','LLL',999,'ans']
    BITS_VALUE_TYPE[57] = ['57','Authorisation life cycle code','LLL',999,'ans']
    BITS_VALUE_TYPE[58] = ['58','Authorising agent institution identification code','LLL',999,'ans']
    BITS_VALUE_TYPE[59] = ['59','Transport data','LLL',999,'ans']
    BITS_VALUE_TYPE[60] = ['60','Reserved for national use','LL',7,'ans']
    BITS_VALUE_TYPE[61] = ['61','Reserved for national use','LLL',999,'ans']
    BITS_VALUE_TYPE[62] = ['62','Reserved for private use','LLL',999,'ans']
    BITS_VALUE_TYPE[63] = ['63','Reserved for private use','LLL',999,'ans']
    BITS_VALUE_TYPE[64] = ['64','Message authentication code (MAC) field','B',16,'b']
    BITS_VALUE_TYPE[65] = ['65','Bitmap tertiary','B',16,'b']
    BITS_VALUE_TYPE[66] = ['66','Settlement code','N',1,'n']
    BITS_VALUE_TYPE[67] = ['67','Extended payment data','N',2,'n']
    BITS_VALUE_TYPE[68] = ['68','Receiving institution country code','N',3,'n']
    BITS_VALUE_TYPE[69] = ['69','Settlement institution county code','N',3,'n']
    BITS_VALUE_TYPE[70] = ['70','Network management Information code','N',3,'n']
    BITS_VALUE_TYPE[71] = ['71','Message number','N',4,'n']
    BITS_VALUE_TYPE[72] = ['72','Data record','LLL',999,'ans']
    BITS_VALUE_TYPE[73] = ['73','Date action','N',6,'n']
    ...
    BITS_VALUE_TYPE[111] = ['111','Reserved for private use','LLL',999,'ans']
    BITS_VALUE_TYPE[112] = ['112','Reserved for private use','LLL',999,'ans']
    BITS_VALUE_TYPE[113] = ['113','Reserved for private use','LL',11,'n']
    ...
    BITS_VALUE_TYPE[122] = ['122','Reserved for national use','LLL',999,'ans']
    BITS_VALUE_TYPE[123] = ['123','Reserved for private use','LLL',999,'ans']
    BITS_VALUE_TYPE[124] = ['124','Info Text','LLL',255,'ans']
    BITS_VALUE_TYPE[125] = ['125','Network management information','LL',50,'ans']
    BITS_VALUE_TYPE[126] = ['126','Issuer trace id','LL',6,'ans']
